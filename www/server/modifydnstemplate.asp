...
%>	
    <tr> 
      <td colspan="2"><div align="right" class="headings">
          <input type="submit" class="commonbutton" name="Add" value="<%=lbl739%>">
          <input type="button" class="commonbutton" name="Add2" value="<%=lbl740%>" onClick="window.location='/server/dnstemplate.asp'">
        </div></td>
    </tr>
	<%
		if(recordType="A") then
