...
<table width="60%" align="center">
  ...
  <tr>
    <td class="clientheading"><form name="form1" action="modifyClientDnsTemplate.asp" method="post">
        <p> 
        <div class="clientheading"><font color="#333333" size="2" face="Verdana, Trebuchet MS"><%=lbl732%></font></div>
        </p>
...
<form name="mainform" method="POST" action ="deleteClientDNSTemplate.asp" onSubmit="return chk_form_data(mainform)">
  <table align="center" width="60%">
    ...
    <tr bgcolor="#006699"> 
      ...
      <td width="10%"><div align="center"  class="headings"> <strong><font color="#FFFFFF" size="2" face="Verdana, Trebuchet MS"><a href="javascript:invertChecked()" style="text-decoration:none; color=#FFFFFF;">Sel</a> 
          </font></strong></div></td>
    </tr>
    <%
...
%>
    <tr> 
      <td colspan="4" align="right"><input type="button" name="test1" value="<%=lblback%>" onClick="window.location='/server/domains.asp'" class="commonbutton"></td>
    </tr>
  </table>
</form>
<body>
