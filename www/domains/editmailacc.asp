...
function validate(f)
{
	...
	f.action='/domains/editmailacc1.asp';
	f.submit();
    return true;
}
</script>
...
<form  method="post" name="mainform" >
  <table width=370 border=0 cellpadding=0 cellspacing=0 align="center">
    ...
    <tr> 
      <th colspan="5"><font color="#003366" size="2" face="Verdana"><strong><%=lbl535%> <font color="red"><%=request("mail")%></font></strong></font>
	</tr>
...
%>
		<input name="old_passwd" type="hidden" id="email" value="test">
<%
	end if
%>
    <tr> 
